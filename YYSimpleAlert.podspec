...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/kak1x/YYSimpleAlert'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'kak1x' => 'ycg02109@naver.com' }
  s.source           = { :git => 'https://github.com/kak1x/YYSimpleAlert.git', :tag => s.version.to_s }
