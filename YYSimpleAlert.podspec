...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/a1ois/YYSimpleAlert'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'a1ois' => 'ycg02109@naver.com' }
  s.source           = { :git => 'https://github.com/a1ois/YYSimpleAlert.git', :tag => s.version.to_s }
